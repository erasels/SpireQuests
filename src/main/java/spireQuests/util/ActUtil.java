        ...
        if (Loader.isModLoaded("actlikeit")) {
            ...
            switch (AbstractDungeon.id) {
                ...
                case "EYB:TheUnnamedReign":
                    return 4;
                default:
                    Anniv8Mod.logger.error("Unrecognized act ID: " + AbstractDungeon.id + ". When ActLikeIt isn't loaded, the only possible acts should be the vanilla four and a few special cases.");
