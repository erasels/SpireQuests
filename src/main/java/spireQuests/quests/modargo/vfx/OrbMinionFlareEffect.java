...
import spireQuests.quests.modargo.monsters.OrbMinion;

public class OrbMinionFlareEffect extends AbstractGameEffect {
    private static TextureAtlas.AtlasRegion outer;
    private static TextureAtlas.AtlasRegion inner;
    private float scaleY;
    private static final float DUR = 0.5F;
    private final OrbMinion orb;
    private final OrbFlareColor flareColor;
    private Color color2;

    public OrbMinionFlareEffect(OrbMinion orb, OrbFlareColor setColor) {
        if (outer == null) {
