...
public abstract class AbstractSQCard extends CustomCard {
    ...
    public AbstractSQCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target) {
        this(cardID, null, cost, type, rarity, target, CardColor.COLORLESS);
    }

    public AbstractSQCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target, final CardColor color) {
    ...
    public AbstractSQCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target, final CardColor color, final String textureString) {
        ...
        if (textureImg.contains("ui/missing.png")) {
            if (CardLibrary.cards != null && !CardLibrary.cards.isEmpty()) {
                CardArtRoller.computeCard(this, false);
            } else
